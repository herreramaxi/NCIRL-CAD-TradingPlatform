...
#       post administrators_url, params: { administrator: { email: @administrator.email, first_name: @administrator.first_name, last_name: @administrator.last_name, password_digest: @administrator.password_digest } }
#     end
